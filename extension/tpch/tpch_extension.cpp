...
static void LoadInternal(ExtensionLoader &loader) {
	...
	dbgen_func.AddNamedParameter("sf", LogicalType::DOUBLE);
	dbgen_func.AddNamedParameter("overwrite", LogicalType::BOOLEAN);
	dbgen_func.AddNamedParameter("catalog", LogicalType::VARCHAR);
	dbgen_func.AddNamedParameter("schema", LogicalType::VARCHAR);
	dbgen_func.AddNamedParameter("suffix", LogicalType::VARCHAR);
	dbgen_func.AddNamedParameter("children", LogicalType::UINTEGER);
	dbgen_func.AddNamedParameter("step", LogicalType::UINTEGER);
