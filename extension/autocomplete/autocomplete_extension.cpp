...
static void LoadInternal(ExtensionLoader &loader) {
	...
	auto_complete_fun.AddNamedParameter("max_suggestion_count", LogicalType::UBIGINT);
	auto_complete_fun.AddNamedParameter("max_file_suggestion_count", LogicalType::UBIGINT);
	auto_complete_fun.AddNamedParameter("max_exact_suggestion_count", LogicalType::UBIGINT);
