...
void JsonV2Extension::Load(ExtensionLoader &loader) {
	LoadInternal(loader);
}

std::string JsonV2Extension::Name() {
	return "json_v2";
}

std::string JsonV2Extension::Version() const {
#ifdef EXT_VERSION_JSON_V2
	return EXT_VERSION_JSON_V2;
#else
	return "";
#endif
}
...
DUCKDB_CPP_EXTENSION_ENTRY(json_v2, loader) {
