...
def enable_line_buffering():
    # utf-8 with backslashreplace: a cp1252 pipe (Windows CI) must never raise UnicodeEncodeError.
    if hasattr(sys.stdout, "reconfigure"):
        sys.stdout.reconfigure(line_buffering=True, write_through=True, encoding="utf-8", errors="backslashreplace")
    if hasattr(sys.stderr, "reconfigure"):
        sys.stderr.reconfigure(line_buffering=True, write_through=True, encoding="utf-8", errors="backslashreplace")
