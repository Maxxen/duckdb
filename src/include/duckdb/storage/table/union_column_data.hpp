...
//                         DuckDB
//
// duckdb/storage/table/union_column_data.hpp
//
//
//===----------------------------------------------------------------------===//
...
//! Union column data represents a union
class UnionColumnData : public ColumnData {
public:
	...
	//! The validity column data of the union
