...
public:
	...
	//! different depth) is skipped, and the bound expression is stored in the binder's BoundExpressionMemo.
...
protected:
	...
	//! The memo holding the bound expressions of already bound parsed nodes
	BoundExpressionMemo &GetMemo() const;
