...
struct GeometryVector {
	static geometry_t AddPoint(Vector &result, uint32_t count);
	static geometry_t AddLineString(Vector &result, uint32_t count);
	static geometry_t AddPolygon(Vector &result, uint32_t count);
