...
static StaticFunctionDefinition internal_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ApplyFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ArrayApplyFun),
	DUCKDB_SCALAR_FUNCTION_ALIAS(ArrayDistinctFun),
	DUCKDB_SCALAR_FUNCTION_ALIAS(ArrayFilterFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ArrayFoldFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ArrayTransformFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(FoldFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListApplyFun),
	DUCKDB_SCALAR_FUNCTION(ListDistinctFun),
	DUCKDB_SCALAR_FUNCTION(ListFilterFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ListFoldFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(ListTransformFun),
