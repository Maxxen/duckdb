...
static const StaticFunctionDefinition function[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(StIntersectExtentFunAlias),
	...
	DUCKDB_SCALAR_FUNCTION_SET(StGeogfromwkbFun),
	DUCKDB_SCALAR_FUNCTION_SET(StGeomfromwkbFun),
	DUCKDB_SCALAR_FUNCTION_SET(StIntersectExtentFun),
