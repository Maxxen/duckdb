...
static const StaticFunctionDefinition function[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(StIntersectsExtentFunAlias),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(StAsbinaryFun),
	DUCKDB_SCALAR_FUNCTION_SET(StAstextFun),
	DUCKDB_SCALAR_FUNCTION_SET(StAswkbFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(StAswktFun),
	DUCKDB_SCALAR_FUNCTION_SET(StCrsFun),
	DUCKDB_SCALAR_FUNCTION(StGeogfromwkbFun),
	DUCKDB_SCALAR_FUNCTION(StGeomfromwkbFun),
	DUCKDB_SCALAR_FUNCTION_SET(StIntersectsExtentFun),
	DUCKDB_SCALAR_FUNCTION_SET(StSetcrsFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(VertexExtractFun),
