...
void ReadCSVTableFunction::ReadCSVAddNamedParameters(TableFunction &table_function) {
	table_function.AddNamedParameter("sep", LogicalType::VARCHAR);
	table_function.AddNamedParameter("delim", LogicalType::VARCHAR);
	table_function.AddNamedParameter("quote", LogicalType::VARCHAR);
	table_function.AddNamedParameter("new_line", LogicalType::VARCHAR);
	table_function.AddNamedParameter("escape", LogicalType::VARCHAR);
	table_function.AddNamedParameter("nullstr", LogicalType::ANY);
	table_function.AddNamedParameter("columns", LogicalType::ANY);
	table_function.AddNamedParameter("auto_type_candidates", LogicalType::ANY);
	table_function.AddNamedParameter("header", LogicalType::BOOLEAN);
	...
	table_function.AddNamedParameter("all_varchar", LogicalType::BOOLEAN);
	...
	table_function.AddNamedParameter("normalize_names", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("compression", LogicalType::VARCHAR);
	table_function.AddNamedParameter("skip", LogicalType::BIGINT);
	table_function.AddNamedParameter("max_line_size", LogicalType::BIGINT);
	table_function.AddNamedParameter("maximum_line_size", LogicalType::BIGINT);
	table_function.AddNamedParameter("ignore_errors", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("store_rejects", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("rejects_table", LogicalType::VARCHAR);
	table_function.AddNamedParameter("rejects_scan", LogicalType::VARCHAR);
	table_function.AddNamedParameter("rejects_limit", LogicalType::BIGINT);
	table_function.AddNamedParameter("rejects_line_size_limit", LogicalType::BIGINT);
	table_function.AddNamedParameter("force_not_null", LogicalType::LIST(LogicalType::VARCHAR));
	table_function.AddNamedParameter("buffer_size", LogicalType::BIGINT);
	table_function.AddNamedParameter("decimal_separator", LogicalType::VARCHAR);
	table_function.AddNamedParameter("parallel", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("null_padding", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("allow_quoted_nulls", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("column_types", LogicalType::ANY);
	table_function.AddNamedParameter("dtypes", LogicalType::ANY);
	table_function.AddNamedParameter("types", LogicalType::ANY);
	table_function.AddNamedParameter("names", LogicalType::LIST(LogicalType::VARCHAR));
	table_function.AddNamedParameter("column_names", LogicalType::LIST(LogicalType::VARCHAR));
	table_function.AddNamedParameter("comment", LogicalType::VARCHAR);
	table_function.AddNamedParameter("encoding", LogicalType::VARCHAR);
	table_function.AddNamedParameter("strict_mode", LogicalType::BOOLEAN);
	table_function.AddNamedParameter("thousands", LogicalType::VARCHAR);
	table_function.AddNamedParameter("files_to_sniff", LogicalType::BIGINT);
