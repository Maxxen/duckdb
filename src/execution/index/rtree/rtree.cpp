...
unique_ptr<IndexScanState> RTree::InitializeScanTwoPredicates(const Transaction &transaction,
...
bool RTree::Scan(const Transaction &transaction, const DataTable &table, IndexScanState &state,
